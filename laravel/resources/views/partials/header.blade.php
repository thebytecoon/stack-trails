            ...
            <div class="flex items-center space-x-4">
                ...
                <button id="cart-button" onclick="toggleCart()" class="p-2 rounded-full hover:bg-gray-100 relative">
                    ...
                    @if ($user_carts->count() > 0)
                        <span id="cart-count" class="absolute -top-1 -right-1 bg-store-blue text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">{{ user_carts.count }}</span>
                    @endif
                </button>
                @auth
                    <div class="relative">
